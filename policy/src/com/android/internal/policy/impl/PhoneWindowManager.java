...
public class PhoneWindowManager implements WindowManagerPolicy {
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.POWER_MENU_EXPANDED_DESKTOP_ENABLED), false, this);
    ...
    public void updateSettings() {
        ...
        synchronized (mLock) {
            ...
            mHasNavigationBar = Settings.System.getInt(mContext.getContentResolver(), Settings.System.NAV_BAR_STATUS, 
                    ...
                    Settings.System.POWER_MENU_EXPANDED_DESKTOP_ENABLED, 0) != 1 && !mHasSystemNavBar;
    ...
    public void beginLayoutLw(int displayWidth, int displayHeight, int displayRotation) {
        ...
        navVisible &= (Settings.System.getInt(mContext.getContentResolver(), Settings.System.POWER_MENU_EXPANDED_DESKTOP_ENABLED, 0) == 0);
    ...
    public int finishAnimationLw() {
        ...
        if (mStatusBar != null) {
            ...
            if (mForceStatusBar) {
                ...
                // case though.
                if (topIsFullscreen || Settings.System.getInt(mContext.getContentResolver(), Settings.System.POWER_MENU_EXPANDED_DESKTOP_ENABLED, 0) == 1) {
